...
data_dir = 'tests/data/'
tmpfile = data_dir + 'tmpfile'
EPS = np.finfo(float).eps

class TestADIPLSFunctions(unittest.TestCase):

    def test_load_mesa_amdl(self):
        D, A, nmod = adipls.load_amdl(data_dir + 'mesa.amdl', return_nmod=True,
                                      return_object=False)
        ...
        a = adipls.load_amdl(data_dir + 'mesa.amdl', return_object=True)
    ...
    def test_amdl_get(self):
        D, A = adipls.load_amdl(data_dir + 'mesa.amdl', return_object=False)
        ...
        m = adipls.load_amdl(data_dir + 'mesa.amdl', return_object=True)
    ...
    def test_load_modelS_agsm(self):
        css = adipls.load_agsm(data_dir + 'modelS.agsm', return_object=False)
        for cs in css:
            self.assertAlmostEqual(cs['M'], 1.989e33)
            self.assertAlmostEqual(cs['R'], 6.959894677e10)

        agsm = adipls.load_agsm(data_dir + 'modelS.agsm', return_object=True)
    ...
    def test_load_modelS_amde(self):
        css1, eigs1, x1 = adipls.load_amde(data_dir + 'modelS_nfmode1.amde', return_object=False)
        css2, eigs2, x2 = adipls.load_amde(data_dir + 'modelS_nfmode2.amde', return_object=False, nfmode=2)
        css3, eigs3, x3 = adipls.load_amde(data_dir + 'modelS_nfmode3.amde', return_object=False, nfmode=3)
        ...
        amde1 = adipls.load_amde(data_dir + 'modelS_nfmode1.amde', return_object=True)
        amde2 = adipls.load_amde(data_dir + 'modelS_nfmode2.amde', return_object=True, nfmode=2)
        amde3 = adipls.load_amde(data_dir + 'modelS_nfmode3.amde', return_object=True, nfmode=3)
    ...
    def test_load_amde_nfmode_value_error(self):
        self.assertRaises(ValueError, adipls.load_amde, data_dir + 'modelS_nfmode1.amde', nfmode=4)

    def test_load_modelS_amdl(self):
        D, A, nmod = adipls.load_amdl(data_dir + 'modelS.amdl', return_nmod=True, return_object=False)
        self.assertEqual(nmod, 1)
    ...
    def test_load_modelS_rkr(self):
        css, rkrs = adipls.load_rkr(data_dir + 'modelS.rkr', return_object=False)

        for cs in css:
            self.assertAlmostEqual(cs['M'], 1.989e33)
            self.assertAlmostEqual(cs['R'], 6.959894677e10)

        rkr = adipls.load_rkr(data_dir + 'modelS.rkr', return_object=True)
    ...
    def test_save_mesa_amdl(self):
        D1, A1, nmod1 = adipls.load_amdl(data_dir + 'mesa.amdl', return_nmod=True, return_object=False)
        ...
        a1 = adipls.load_amdl(data_dir + 'mesa.amdl', return_object=True)
        a1.to_file(tmpfile)
    ...
    def test_save_modelS_amdl(self):
        D1, A1, nmod1 = adipls.load_amdl(data_dir + 'modelS.amdl', return_nmod=True, return_object=False)
        adipls.save_amdl(tmpfile, D1, A1, nmod=nmod1)
        D2, A2, nmod2 = adipls.load_amdl(tmpfile, return_nmod=True, return_object=False)
        np.testing.assert_equal(nmod1, nmod2)
        np.testing.assert_equal(len(A1), len(A2))
        ...
        a1 = adipls.load_amdl(data_dir + 'modelS.amdl', return_object=True)
        a1.to_file(tmpfile)
        a2 = adipls.load_amdl(tmpfile, return_object=True)
        np.testing.assert_equal(a1.nmod, a2.nmod)
        np.testing.assert_equal(a1.nn, a2.nn)
    ...
    def test_fgong_to_amdl_modelS(self):
        D1, A1 = adipls.load_amdl(data_dir + 'modelS.amdl', return_object=False)
        glob, var = fgong.load_fgong(data_dir + 'modelS.fgong', return_object=False)
        ...
        a1 = adipls.load_amdl(data_dir + 'modelS.amdl', return_object=True,
                              G=6.67232e-8)
        m2 = fgong.load_fgong(data_dir + 'modelS.fgong', return_object=True,
                              G=6.67232e-8)
        a2 = m2.to_amdl()
    ...
    def test_fgong_to_amdl_mesa(self):
        D1, A1 = adipls.load_amdl(data_dir + 'mesa.amdl', return_object=False)
        glob, var = fgong.load_fgong(data_dir + 'mesa.fgong', return_object=False)
        ...
        a1 = adipls.load_amdl(data_dir + 'mesa.amdl', return_object=True,
                              G=6.67428e-8)
        f = fgong.load_fgong(data_dir + 'mesa.fgong', return_object=True,
                             G=6.67428e-8)
        a2 = f.to_amdl()
    ...
    def test_amdl_to_fgong_modelS(self):
        ...
        D, A = adipls.load_amdl(data_dir + 'modelS.amdl', return_object=False)
        glob1, var1 = fgong.load_fgong(data_dir + 'modelS.fgong', return_object=False)
        ...
        m1 = fgong.load_fgong(data_dir + 'modelS.fgong', return_object=True,
                              G=6.67232e-8)
        a2 = adipls.load_amdl(data_dir + 'modelS.amdl', return_object=True,
                              G=6.67232e-8)
        m2 = a2.to_fgong()
    ...
    def test_amdl_to_fgong_mesa(self):
        ...
        D, A = adipls.load_amdl(data_dir + 'mesa.amdl', return_object=False)
        glob1, var1 = fgong.load_fgong(data_dir + 'mesa.fgong', return_object=False)
        glob2, var2 = adipls.amdl_to_fgong(D, A, G=6.67428e-8)

        np.testing.assert_allclose(glob1[:2], glob2[:2])
        np.testing.assert_allclose(var1[:,I], var2[:,I])

        m1 = fgong.load_fgong(data_dir + 'mesa.fgong', return_object=True,
                              G=6.67428e-8)
        a2 = adipls.load_amdl(data_dir + 'mesa.amdl', return_object=True,
                              G=6.67428e-8)
        m2 = a2.to_fgong()
    ...
    def test_cross_check_css(self):
        css_agsm = adipls.load_agsm(data_dir + 'modelS.agsm', return_object=False)
        css_amde = adipls.load_amde(data_dir + 'modelS_nfmode1.amde', return_object=False)[0]
        css_rkr = adipls.load_rkr(data_dir + 'modelS.rkr', return_object=False)[0]
        np.testing.assert_equal(css_agsm, css_amde)
        np.testing.assert_equal(css_agsm, css_rkr)

        agsm = adipls.load_agsm(data_dir + 'modelS.agsm', return_object=True)
        amde = adipls.load_amde(data_dir + 'modelS_nfmode1.amde', return_object=True)
        rkr = adipls.load_rkr(data_dir + 'modelS.rkr', return_object=True)
